...
export default async function handler(req, res) {
  ...
  try {
    ...
    const finalData = {
      ...
      enable_history_label: cleanText(req.body?.enableHistoryLabel ?? current.enable_history_label),
    ...
    if (!existing.rows.length) {
      await pool.query(
        ...
        [
          ...
          finalData.enable_history_label,
