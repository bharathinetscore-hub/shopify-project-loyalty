...
const RUN_AFTER_HOUR = Number.parseInt(process.env.LOYALTY_AWARD_RUN_HOUR || "0", 10);
const RUN_AFTER_MINUTE = Number.parseInt(process.env.LOYALTY_AWARD_RUN_MINUTE || "5", 10);
